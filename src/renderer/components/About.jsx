  ...
  return (
    <div className="about-page">
      ...
      <div className="about-section card about-company">
        ...
        />
        <p className="company-description">{t('about.company')}</p>

        {/* Contact Information */}
        <div className="contact-info">
          <h3>{t('about.contact.title')}</h3>
          <p className="contact-message">{t('about.contact.message')}</p>
          ...
          <div className="contact-details">
            <div className="contact-item">
              ...
              <a href="mailto:contact@brainytech.net">contact@brainytech.net</a>
            </div>
            ...
            <div className="contact-item">
              ...
              <a href="tel:+905439565709">0543 956 57 09</a>
            </div>
            ...
            <div className="contact-item">
              ...
              <a href="https://brainytech.net" target="_blank" rel="noopener noreferrer">brainytech.net</a>
            </div>
          </div>
        </div>
      </div>
