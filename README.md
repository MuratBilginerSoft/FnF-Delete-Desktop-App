...
- 🗑️ **Recycle Bin Management** - View, filter, search and permanently delete files from trash
...
- 🗑️ **Geri Dönüşüm Kutusu Yönetimi** - Çöp kutusundaki dosyaları görüntüle, filtrele, ara ve kalıcı sil
